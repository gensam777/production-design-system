...
| Card (verified 2026-09-12) | `967:9` ("Card") | `967:1625` (6 variants — Variant × Padding) | Flat set, no nesting. No compound sub-parts (Header/Body/Footer) — consumer composes freely inside `children`. `outlined` (border.default) / `elevated` (surface.raised + elevation.raised, no border). React: `src/components/Card/Card.tsx`. |
